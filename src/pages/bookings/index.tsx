...
import { useBookingsQuery } from '@/data/booking';
...
export default function BookingsPage() {
  ...
  const { bookings, loading, paginatorInfo, error } = useBookingsQuery({
    language: locale,
    limit: 20,
    page,
    // type,
...
BookingsPage.authenticate = {
  permissions: adminOnly,
};
BookingsPage.Layout = Layout;
