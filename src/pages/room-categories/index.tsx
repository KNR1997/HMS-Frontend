...
import RoomCategoryList from '@/components/roomCategory/room-category-list';
...
export default function RoomCategoriesPage() {
  ...
  const { roomCategories, loading, paginatorInfo, error } = useRoomCategoriesQuery({
    language: locale,
    limit: 20,
    page,
    // type,
      ...
      <Card className="mb-8 flex flex-col">
        <div className="flex w-full flex-col items-center md:flex-row">
          <div className="mb-4 md:mb-0 md:w-1/4">
            <PageHeading title='Room Categories' />
          </div>
...
RoomCategoriesPage.authenticate = {
  permissions: adminOnly,
};
RoomCategoriesPage.Layout = Layout;
